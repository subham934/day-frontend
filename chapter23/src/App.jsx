...
const App = () => {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-neutral-950" : "bg-neutral-100"} min-h-screen flex flex-col gap-10 items-center justify-center`}>
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl px-16 py-12 flex flex-col items-center gap-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-xs text-zinc-600 font-medium">current value</span>
        </div>
